package uk.co.techblue.rabbitmq.core.consumer;
...
/**
 * Base Consumer class that used to initialize consumers. Intented to extend this on Consumer implementations. Extends the
 * DefaultConsumer class from RabbitMQ library. To get the {@link Message} from the broker override the
...
public abstract class RabbitMqConsumer extends DefaultConsumer {
    ...
    /**
     * Constructs new instance of {@link DefaultConsumer} with given {@link Channel}.
     *
    ...
    public void handleShutdownSignal(String consumerTag, ShutdownSignalException sig) {
        LOG.debug("Consumer: {} Received shutdown signal: {}", consumerTag, sig.getMessage());
    }
    ...
    public void handleDelivery(String consumerTag, Envelope envelope, BasicProperties properties, byte[] body)
        ...
        Message message = new Message(properties, body, envelope.getExchange(), envelope.getRoutingKey(),
                envelope.getDeliveryTag());

        LOG.info("Consumer: {} Received message: {}", consumerTag, envelope.getDeliveryTag());
    ...
    public void basicConsume() throws IOException {
        ...
        _channel.basicConsume(_channel.queueDeclare().getQueue(), autoAck, this);
    }
